...
"for example: alertnotify=echo %%s | mail -s \"CuriusCoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. CuriusCoin is shutting down."),
